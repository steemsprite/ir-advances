...
\input{sections/eyeTracking}

\section{Search user behavior}

\input{sections/verboseQueries}

\input{sections/qrModels}

\input{sections/queryRecommendation}

\input{sections/implicitFeedback}

\section{Search output quality}

\input{sections/contextRanking}

\input{sections/quilted}

\input{sections/typeSearch}
